...
const CreatePostForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:5009/posts', formData, {
        headers: {
    ...
    <div className="flex flex-col items-center mt-16 p-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col w-full max-w-lg space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className={`px-6 py-2 mt-4 rounded-md text-white ${loading ? 'bg-gray-400' : 'bg-blue-500 hover:bg-blue-600'} focus:outline-none`}
        >
